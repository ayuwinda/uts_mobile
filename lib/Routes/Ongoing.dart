...
class _OngoingState extends State<Ongoing> {
  ...
  Widget pageIndexIndicator(bool isCurrentWidget) {
    return Container(
      ...
      decoration: BoxDecoration(color: isCurrentWidget ? Colors.grey : Colors.grey[300], borderRadius: BorderRadius.circular(12)),
    );
  }
    ...
    return Scaffold(
      ...
      body: PageView.builder(
        ...
        itemBuilder: (context, index) {
          return SlideTiles(Sliders[index].imagePath, Sliders[index].title, Sliders[index].text);
        },
          ...
          ? Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      for (int i = 0; i < Sliders.length; i++) i == currentState ? pageIndexIndicator(true) : pageIndexIndicator(false)
                    ],
                  ),
                  GestureDetector(
                    child: Text("Lanjut"),
